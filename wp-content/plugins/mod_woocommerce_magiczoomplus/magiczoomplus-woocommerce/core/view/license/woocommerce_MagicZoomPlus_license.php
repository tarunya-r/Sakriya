<?php
    ...
    $plugin_version = plugin_get_version_WooCommerce_MagicZoomPlus();
    $isKey = magictoolbox_WooCommerce_MagicZoomPlus_get_data_from_db();
    $isScrollKey = false;
    $isScrollKey = magictoolbox_WooCommerce_MagicZoomPlus_get_data_from_db('WooCommerce_MagicZoomPlus_magicscroll');
?>
<div class="license-container">
    <h1>Your Magic Zoom Plus license</h1>
    ...
    <div class="magictoolbox-trial-box update-nag" style="width: 300px;    float: right;    display: inline-block;    margin-right: 45px; padding: 20px;">
        ...
        You're using the Trial Version of Magic Zoom Plus. You get all the features and it has no time limit. It displays a message on the zoomed image.
        To remove the message, please <a target="_blank" href="<?php echo WooCommerceMagicZoomPlus_url('https://www.magictoolbox.com/buy/magiczoomplus/','license page trial badge buy link'); ?>">buy a license</a>.
        </br></br>
        ...
        If you ever want to switch to another storefront in future, you can choose from 40+ different extensions that are included in your Magic Zoom Plus license.
        </br></br>
    ...
    <div class="magictoolbox-trial-text">
        <p>You're using the <b>Trial</b> version (or license key isn't entered) of Magic Zoom Plus.</p>
        <p>All features are included and there's no time limit.</p>

        </br>
        <h2><b>Upgrade now</b></h2>
        <p>To remove the red message "Magic Zoom Plus&trade; trial version", buy a license:</p>
        <p><a href="<?php echo WooCommerceMagicZoomPlus_url('https://www.magictoolbox.com/buy/magiczoomplus/','license page buy your license link'); ?>" target="_blank" class="button button-primary orange-button">Buy my Magic Zoom Plus license &gt;</a></p>
        <p>
        ...
        <h2><b>Register your Magic Zoom Plus license</b></h2>
            ...
            <div style="position: relative; display: inline-block; vertical-alight: middle;">
                ...
                <div class="msg-wrapper">
                    ...
                    <div class="problem sad-message">
                        There was a problem with checking your license key. Please <a target="_blank" href="<?php echo WooCommerceMagicZoomPlus_url('https://www.magictoolbox.com/contact/','license page problem contact link'); ?>">contact us</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        <p>
            <a href="<?php echo WooCommerceMagicZoomPlus_url('https://www.magictoolbox.com/buy/magicscroll/','license page buy your license link'); ?>" target="_blank" class="button button-primary orange-button">Buy my Magic Scroll license &gt;</a>
        </p>
    ...
    <p>Thanks for using Magic Zoom Plus!</p>
</div>
