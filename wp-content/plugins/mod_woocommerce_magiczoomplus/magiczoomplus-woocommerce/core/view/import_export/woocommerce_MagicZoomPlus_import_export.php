...
<div class="import-export-container">
    <h1>Magic Zoom Plus settings backup / restore</h1>
    <p>Save your plugin settings so you can import them into another WordPress website e.g. a development or staging site. Or if you'll be removing/reinstalling the Magic Zoom Plus plugin.</p>
    <br/>
