(function ($) {
    ...
    function importClick(e) {
        ...
        formData.append('action', 'WooCommerce_MagicZoomPlus_import');
        formData.append('nonce', magictoolbox_WooCommerce_MagicZoomPlus_admin_modal_object.nonce);
        ...
        xhr.open("POST", magictoolbox_WooCommerce_MagicZoomPlus_admin_modal_object.ajax, true);
        xhr.send(formData);
    ...
    function exportClick(e) {
        ...
        f.attr('method', 'post');
        f.attr('action', magictoolbox_WooCommerce_MagicZoomPlus_admin_modal_object.ajax);
        ...
        i.attr('type', 'hidden');
        i.attr('name', 'action');
        i.attr('value', 'WooCommerce_MagicZoomPlus_export');
        f.append(i[0]);
        ...
        i.attr('type', 'hidden');
        i.attr('name', 'nonce');
        i.attr('value', magictoolbox_WooCommerce_MagicZoomPlus_admin_modal_object.nonce);
        f.append(i[0]);
