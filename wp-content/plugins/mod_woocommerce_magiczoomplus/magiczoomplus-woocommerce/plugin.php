...
function WooCommerce_MagicZoomPlus_send_stat($action = '') {
    ...
    if('working' == 'v6.7.20' || 'working' == 'v5.2.5') {
        return;
    }
    ...
    $path = "api/stat/?action={$action}&tool_name=magiczoomplus&license=trial&tool_version=v5.2.5&module_version=v6.7.20&platform_name=woocommerce&platform_version={$platformVersion}&url={$url}";
...
function  magictoolbox_WooCommerce_MagicZoomPlus_init() {
    ...
    if (!$coreClass->params->checkValue('page-status','No','product')) {
        add_filter( 'woocommerce_locate_template', 'WooCommerce_MagicZoomPlus_locate_template', 20, 3 );
    }
...
function magictoolbox_WooCommerce_MagicZoomPlus_add_src_to_footer() {
    ...
    if (!$magictoolbox_page_added_gallery_script && $magictoolbox_page_has_gallery) {
        ...
        wp_enqueue_style('magictoolbox_magiczoomplus_gullery_style');
        wp_enqueue_script('magictoolbox_magiczoomplus_gullery_script');
    }
}
...
function magictoolbox_WooCommerce_MagicZoomPlus_config_page_menu() {
    if(function_exists("add_menu_page")) {
        $page = add_menu_page(__("Magic Zoom Plus for WooCommerce"), __("Magic Zoom Plus for WooCommerce"), "edit_posts", "WooCommerceMagicZoomPlus-config-page", "WooCommerceMagicZoomPlus_config_page", plugin_dir_url( __FILE__ )."core/admin_graphics/icon.png");
...
function WooCommerce_MagicZoomPlus_get_prepared_selectors ($useWpImages = false) {
