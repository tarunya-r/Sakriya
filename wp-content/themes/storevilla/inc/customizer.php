  ...
  */
  ...
  $wp_customize->add_section(
      new Storevilla_Customize_Section_Pro(
          ...
          'uncode-pro',
          array(
              'title'    => esc_html__( 'Upgrade To Sorevilla Pro', 'storevilla' ),
              'title1'    => esc_html__( 'Free vs Pro', 'storevilla' ),
              'pro_text' => esc_html__( 'Buy Now','storevilla' ),
              'pro_text1' => esc_html__( 'Compare','storevilla' ),
              'pro_url'  => 'https://accesspressthemes.com/wordpress-themes/storevilla-pro/',
