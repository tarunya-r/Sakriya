...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '15px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#838383'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '40px', 'lineheight' => '42px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#838383'));
			...
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '19px', 'lineheight' => '32px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#01a2a6'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#838383'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#838383'));
